...
final class Route
{
    ...
    static public function app()
    {
        ...
        //以下划线分隔的模块名称改为pascal命名如SZPHP_user=>SZPHPUser
    ...
    static private function setConst()
    {
        ...
        //框架目录相关URL
        defined('__SZPHP__') or define("__SZPHP__", __HOST__ . '/' . trim(str_ireplace(str_replace('\\', '/', $_SERVER['DOCUMENT_ROOT']), "", SZPHP_PATH), '/'));
        defined('__SZPHP_DATA__') or define("__SZPHP_DATA__", __SZPHP__ . '/Data');
        defined('__SZPHP_TPL__') or define("__SZPHP_TPL__", __SZPHP__ . '/Lib/Tpl');
        defined('__SZPHP_EXTEND__') or define("__SZPHP_EXTEND__", __SZPHP__ . '/Extend');
        //控制器
		...
		defined("__TEMPLATE__") or define("__TEMPLATE__", __ROOT__ . '/template');//深知网
