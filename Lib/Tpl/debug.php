<?php if (!defined('SZPHP_PATH')) exit; ?>
...
<style type="text/css">
    ...
    div#sz_debug div#debug_menu {
        height: 25px;
        border-bottom: solid 2px #009CAE;
    }

    div#sz_debug div#debug_menu ul {
        list-style: none;
        padding: 0px;
        margin: 0px;
    }

    div#sz_debug div#debug_menu ul li {
        float: left;
        cursor: pointer;
        height: 24px;
        width: 65px;
    ...
    div#sz_debug div#debug_menu ul li.active {
        background: #009CAE;
        color: #fff;
        height: 25px;
        border: none;
    ...
    div#sz_debug div#debug_con div {
        display: none;
        height: 200px;
        overflow-x: hidden;
        overflow-y: auto;
    ...
    div#sz_debug div#debug_con div.active {
        display: block;
    }

    div#sz_debug div#debug_con div table {
        width: 100%;
        border-collapse: collapse;
    }

    div#sz_debug div#debug_con div table thead tr {
        background: #f3f3f3;
    }
    div#sz_debug div#debug_con div table thead tr td{
        background: #F3F3F3;
        font-weight: normal;
    }
    div#sz_debug div#debug_con div table tr td {
    ...
    #sz_debug_bt {
        background: url("<?php echo __SZPHP_DATA__;?>/Image/debug.png") no-repeat;
        border-radius: 0px;
        cursor: pointer;
        z-index: 2000;
        width: 25px;
...
<div id="sz_debug">
    <div id="debug_menu">
        <ul>
            ...
            <li id="_const">常量</li>
            <li>
                <a href='<?php echo dirname(__SZPHP__).'/setup/index.php'?>?m=delcache&temp=<?php echo TEMP_PATH;?>'>删除缓存</a>
            </li>
            <li>
                <a href='<?php echo dirname(__SZPHP__).'/setup/index.php'?>?c=rbac' target='_blank'>RBAC</a>
            </li>
            <li>
                <a href="http://bbs.shenzhiwang.com" target="_blank">论坛交流</a>
            </li>
        </ul>
    </div>
    <div id="debug_con">
        ...
        <div id="server" class="active">
            <table>
                ...
                <tr>
                    <td>框架版本</td>
                    <td><?php echo SZPHP_VERSION ?>
                        <a href='http://www.shenzhiwang.com/version.php?ver=<?php echo str_replace(".", "", SZPHP_VERSION) ?>'
        ...
        <div id="session">
            <table width=100%>
                ...
                <tr>
                    ...
                    <td>
                        value
                        <a href='<?php echo dirname(__SZPHP__).'/setup/index.php'?>?c=session&path_root=%2Fwww%2FSZPHP%2Fexample%2FApp%2F&app=http%3A%2F%2Flocalhost%2FSZPHP%2Fexample%2FApp%2Findex.php%2F1%2FIndex%2Findex'
...
<!--开启debug按钮-->
<div id="sz_debug_bt">SZPHP</div>
<script>
    var _sz_debug_bt = document.getElementById("sz_debug_bt");
    var _sz_debug = document.getElementById("sz_debug");
    document.getElementById("sz_debug_bt").onclick = function () {
        if (_sz_debug.style.display) {
            _sz_debug.style.display = "";
        } else {
            _sz_debug.style.display = "block";
        }
    }
</script>