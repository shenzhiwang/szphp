 ...
 */
require SZPHP_EXTEND_PATH . 'Org/Mail/Class.phpmailer.php';
class Mail{
	...
	static private function config() {
		...
		self::$mail -> PluginDir = SZPHP_EXTEND_PATH . 'Org/Mail/';
		self::$mail -> SetLanguage("en", SZPHP_EXTEND_PATH . '/Mail/Language/');
		self::$mail -> IsSMTP();
		//是否为SMTP 必须设置
